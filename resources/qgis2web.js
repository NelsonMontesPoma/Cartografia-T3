...
map.getView().fit([-8897976.186846, -1010446.274071, -8521664.020492, -761726.440266], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa provincias de la libertad</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (120 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso Cartografia y sist. inf. geog. en el ciclo 2025-2 por el alumno Montes Poma Nelson';
            }
